...
export const Root: React.FC<ComponentProps<typeof RadixToolip.Root> & {
...
export const Trigger: React.FC<ComponentProps<typeof RadixToolip.Trigger>> = (props) => {
   return (
      <RadixToolip.Trigger {...props}>{props.children}</RadixToolip.Trigger>
   );
};
export const Portal = (props: ComponentProps<typeof RadixToolip.Portal>) => {
   return (
      <RadixToolip.Portal {...props}>{props.children}</RadixToolip.Portal>
   );
};

export const Content: React.FC<Omit<
   ComponentProps<typeof RadixToolip.Content>,
   "children" | "asChild"
> & {
   tooltip: React.ReactNode;
   defaultTooltip?: boolean;
